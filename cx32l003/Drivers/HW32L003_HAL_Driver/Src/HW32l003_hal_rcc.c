...
/**
  ...
  * @note     If SYSCLK source is HIRC, function returns values based on HIRC_VALUE
  ...
  * @note     HIRC_VALUE is a constant defined in HW32l003_hal_conf.h file (default value
  *           4 MHz) but the real value may vary depending on the variations
  *           in voltage and temperature.
  * @note     HXT_VALUE is a constant defined in HW32l003_hal_conf.h file (default value
  *           8 MHz), user has to ensure that HSE_VALUE is same as the real
  *           frequency of the crystal used. Otherwise, this function may
  *           have wrong result.  
  * @note     LIRC_VALUE is a constant defined in HW32l003_hal_conf.h file (default value
  *           38.4 KHz) but the real value may vary depending on the variations
  *           in voltage and temperature.
  * @note     LXT_VALUE is a constant defined in HW32l003_hal_conf.h file (default value
