...
#ifndef __HW32L003_HAL_TIM_H
#define __HW32L003_HAL_TIM_H
...
HAL_StatusTypeDef HAL_TIM_ConfigBreakDeadTime(TIM_HandleTypeDef *htim, TIM_BreakDeadTimeConfigTypeDef *sBreakDeadTimeConfig);
/**
  * @}
  */
