...
#ifndef __HW32L003_HAL_LPUART_H
#define __HW32L003_HAL_LPUART_H
...
/** @defgroup LPUART_Word_Length LPUART Word Length
  * @{
  */
#define LPUART_WORDLENGTH_8B                  ((uint32_t)LPUART_SCON_SM0_SM1_1)
#define LPUART_WORDLENGTH_9B                  ((uint32_t)(LPUART_SCON_SM0_SM1_0 | LPUART_SCON_SM0_SM1_1))
/**
  * @}
  */
